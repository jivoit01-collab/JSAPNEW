...
namespace JSAPNEW.Services.Interfaces
{
    public interface IBPmasterService
    {
        ...
        Task<IEnumerable<DistinctBankNameModel>> GetBankCodesAsync(int company, string countryCode = "IN");
        ...
        Task<IEnumerable<GroupNameResponse>> GetBPGroupsAsync(int company, string bpType);
        Task<IEnumerable<BpAccountOptionModel>> GetARAccountsAsync(int company);
        Task<IEnumerable<BpAccountOptionModel>> GetAPAccountsAsync(int company);
        Task<IEnumerable<PaymentGroupModel>> GetPaymentTermsAsync(int company);
        Task<IEnumerable<SLPnameModel>> GetSalesEmployeesAsync(int company);
        Task<IEnumerable<BpTerritoryOptionModel>> GetTerritoriesAsync(int company);
